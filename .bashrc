...
alias sudo='doas'
alias pipenv='pipenv --python /usr/bin/python3'
alias pirp='pipenv --python /usr/bin/python3'
alias backup-native-packages='pacman -Qqen > pkglist.txt'
alias backup-aur-packages='pacman -Qqem > aurlist.txt'
alias bm='bashmount'
